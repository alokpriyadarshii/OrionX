...
Imports MemoryManager and MemoryVectorStore from the OrionX codebase.
"""
...
_OWNER_ENV_KEYS = ("ORIONX_MCP_MEMORY_OWNER", "ORIONX_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set ORIONX_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
