...
<#
  Build a portable Windows distribution for OrionX.

  Output layout:
    dist\OrionX\OrionX.exe
    dist\OrionX\static\...
    dist\OrionX\scripts\...
    dist\OrionX\mcp_servers\...
    dist\OrionX\services\hwfit\data\...
...
& $pyExe -m PyInstaller --noconfirm --clean --onedir --noconsole --icon=static/icon.ico --name OrionX @dataArgs launcher.py
if ($LASTEXITCODE -ne 0) { Fail "PyInstaller build failed." }

Write-Host ""
Write-Host "Build complete." -ForegroundColor Green
Write-Host "Portable app folder: $PSScriptRoot\dist\OrionX" -ForegroundColor Green
