...
function initMermaid() {
  if (!window.mermaid || window.__orionxMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__orionxMermaidReady = true;
}
window.orionxInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'orionx-thinking-expanded';
