...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'orionx-model-expanded',
  MODEL_ENDPOINTS: 'orionx-model-endpoints',
  MODEL_SELECTED: 'orionx-selected-model',
  SORT_ORDER: 'orionx-sessions-sort',
  CHAT_SEARCH_SCOPE: 'orionx-search-scope',
  INCOGNITO: 'orionx-incognito',
  RAG_ACTIVE: 'orionx-rag-active',
  MCP_ACTIVE: 'orionx-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'orionx-density',
  UI_SCALE: 'orionx-ui-scale',
  WORKSPACE: 'orionx-workspace'
};
