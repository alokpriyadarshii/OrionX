...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'orionx-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'orionx-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('orionx:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
