...
const LS_KEY = 'orionx-theme';
const CUSTOM_THEMES_KEY = 'orionx-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'OrionX Logo',    group: 'Sidebar' },
...
function _updateFavicon(fg) {
  ...
  if (routeShape) {
    ...
    href = '/static/icons/orionx-star.svg';
  }
...
const UI_SCALE_KEY = 'orionx-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'orionx_' + (obj.name || 'theme') + '.json';
      a.click();
