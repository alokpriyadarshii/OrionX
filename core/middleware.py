...
INTERNAL_TOOL_TOKEN = os.environ.get("ORIONX_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-OrionX-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-OrionX-Internal-Token), or
