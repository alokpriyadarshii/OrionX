"""scripts/_lib/cli.py — shared scaffolding for the `orionx-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("orionx-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/orionx-foo`
...
VERSION = "0.1.0"  # bumped centrally; every orionx-* CLI reports this
