...
COPILOT_USER_AGENT = os.environ.get(
    "ORIONX_COPILOT_USER_AGENT", "OrionX/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "ORIONX_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "ORIONX_COPILOT_EDITOR_VERSION", "OrionX/1.0"
)
