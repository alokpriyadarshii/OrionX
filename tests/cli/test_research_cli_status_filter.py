"""`orionx-research list --status complete` was returning nothing.
...
Part of #2122 (orionx-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "orionx-research"
    loader = importlib.machinery.SourceFileLoader("orionx_research_cli", str(path))
